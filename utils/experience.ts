export const experience = [
  {
    ...
    company: "WSC Sports",
    position: "GenAI & NLP Algorithm Engineer",
    description: [
  ...
  },
  {
    ...
    position: "Algorithm Engineer - CTO Group",
    description: [
  ...
  {
    date: "NOV 2015 - AUG 2020",
    company: "J6 & Cyber Defence Directorate, IDF",
    position: "Communications (C4I) Officer",
    description: [
